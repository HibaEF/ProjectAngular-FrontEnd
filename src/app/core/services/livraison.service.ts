...
url=environment.url+"livraison/";
 ...
 {
   return this.http.post(this.url+"add-livraison/"+livraison.l.id+"/"+livraison.f.idFacture,livraison, this.httpOptions)
 }
  getLivraisonServiceById(id:any){
    return this.http.get<Livraison>(this.url+"retrieve-livraison/"+id, this.httpOptions);
  }
  ...
  deliverLivraison(id:number){
    return this.http.put(this.url+"deliver-livraison/"+id, this.httpOptions);
  }
